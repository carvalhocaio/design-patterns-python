...
class Reprovado(Estado_de_um_orcamento):
    ...
    def aprova(self, orcamento):
        raise Exception('Orçamentos reprocados não podem ser aprovados')

    def reprova(self, orcamento):
        raise Exception('Orçamentos já está reprovado')
...
class Finalizado(Estado_de_um_orcamento):
    ...
    def reprova(self, orcamento):
        raise Exception(
            'Orçamentos finalizados não podem ser reprovados novamente')
